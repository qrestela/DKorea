<div class="container-fluid">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td>
              <a href="#" class="btn btn-danger btn-sm" onclick="confirmDelete(<?php echo $brg->id_brg; ?>)">
            ...
            function confirmDelete(id_brg) {
                var confirmation = confirm("Yakin ingin hapus?");
                if (confirmation) {
                    window.location.href = "<?php echo base_url('admin/data_barang/hapus/'); ?>" + id_brg;
                }
            }
            </script>
